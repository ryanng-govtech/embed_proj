...
class GoogleWebViewApp extends StatefulWidget {
  const GoogleWebViewApp({super.key});

  @override
  State<GoogleWebViewApp> createState() => _RafaWebViewAppState();
}

class _RafaWebViewAppState extends State<GoogleWebViewApp> {
  late final WebViewController controller;
  String url = 'https://fem.jtc.gov.sg/rafa/#/';
  // String url = 'https://google.com.sg';
